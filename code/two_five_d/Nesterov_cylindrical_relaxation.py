...
def relaxation_pressure(
    order       = 2,
    T           = 1e3 ,
    dt_val      = 0.5,  # If using the golden stepsize, this should be set sufficiently low that a uniform stepsize does not see oscillations
